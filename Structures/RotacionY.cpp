...
RotacionNodeY *RotacionY::Create_Node(int Id, int Col, int Fil, int ColorR, int ColorG, int ColorB, string ColorHexa) {
    RotacionNodeY *New_Nodo = new RotacionNodeY;
    New_Nodo->Id = Id;
    New_Nodo->Col = Col;
    New_Nodo->Fil = Fil;
...
bool RotacionY::IsEmptyP() {
    return  FirstRotation == NULL;
}
void RotacionY::AddROTACIONY(int Id, int Col, int Fil, int ColorR, int ColorG, int ColorB, string ColorHexa) {
    RotacionNodeY *New_Nodo = Create_Node(Id, Col, Fil, ColorR, ColorG, ColorB, ColorHexa);
    if (IsEmptyP()) {
...
void RotacionY::T(int Tama) {
    Ta = Tama;
}

void RotacionY::HTMLY() {
    string a = "";
...
void RotacionY::CCSSY(int WidthC, int HeightC, int WidthP, int HeightP) {
    string a = "";
...
string RotacionY::HtmlRY(string html) {
    html += "<!DOCTYPE html > \n";
    html += "<html> \n";
    html += "<head> \n";
...
string RotacionY::CssRY(string css, int WidthC, int HeightC, int WidthP, int HeightP) {
    int TCanvasW = WidthP * WidthC;
    int TConvasH = HeightP * HeightC;
    RotacionNodeY *Aux = FirstRotation;
    css += "body {\n"
